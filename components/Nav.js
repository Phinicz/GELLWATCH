...
const Nav = ({ selected, handleDropDown, cart, screenSize }) => {
  ...
  return (
    <div>
      {screenSize <= 760 ? (
        <div className="flex fixed w-full justify-between bg-white p-5">
          <div className="flex gap-3 items-center">
            <RxHamburgerMenu
              className="text-3xl border-2 p-1 border-black rounded-lg text-black"
              onClick={toggleMenu}
            />
            {isMenuOpen && (
              <ul className="absolute top-16 left-0 bg-white border border-gray-300 rounded shadow-md py-2 px-4">
            ...
            <div className="font-semibold text-xl">GELLWATCH</div>
          </div>
